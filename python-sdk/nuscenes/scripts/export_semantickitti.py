    ...
    def nuscenes_gt_to_semantickitti(self):
        ...
        for scene_idx, scene in enumerate(self.nusc.scene):
            ...
            while True:
                ...
                lidar_panoptic = self.nusc.get('panoptic', lidar_data_token)
                ### {'token', 'sample_data_token', 'filename'}

                lidar_panoptic_anno = load_bin_file(os.path.join(self.nusc.dataroot, lidar_panoptic['filename']), type='panoptic')
